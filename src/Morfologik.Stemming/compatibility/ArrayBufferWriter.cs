...
namespace Morfologik.Stemming
{
    ...
    internal sealed class ArrayBufferWriter<T> : IBufferWriter<T>
    {
        ...
        private static class SR
        {
            ...
            public const string BufferWriterAdvancedTooFar = "The writer advanced past the end of the buffer with capacity {0}.";
            public const string BufferMaximumSizeExceeded = "The maximum size of the buffer was exceeded. The requested capacity is {0}.";
        }
    }
}
